...
define config.name = _("Cybersecurity")
...
define gui.about = _p("""Cybersecurity - это игра по профориентации абитуриентов. Вы познакомитесь с историей маленького человека, который достиг больших высот.
""")
...
define build.name = "Cybersecurity"
...
define config.main_menu_music = "future.mp3"
...
define config.save_directory = "Cybersecurity-1699681704"
